...
console.log(`Hello my name is ${name} and my repo count is ${repoCount}`); // this is an example of string interpolation
...
let aComplexName = 'viplav  sanjay mankar'
console.log(aComplexName.split(' '));
